...
/// `com.pawmodoro.zhangcheng`. If that ever changes, change these to match and
...
enum StoreIDs {
    ...
    static let plus = "com.pawmodoro.zhangcheng.plus"

    /// Consumables: optional tips, which unlock nothing.
    static let tipSmall = "com.pawmodoro.zhangcheng.tip.small"
    static let tipMedium = "com.pawmodoro.zhangcheng.tip.medium"
    static let tipLarge = "com.pawmodoro.zhangcheng.tip.large"
